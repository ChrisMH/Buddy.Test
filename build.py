...
solutionFile = r"Buddy.Test.sln"

projectFiles = [
    r"Buddy.Test45\Buddy.Test45.csproj", 
    r"Buddy.Test451\Buddy.Test451.csproj",  
    r"Buddy.Test452\Buddy.Test452.csproj",  
    r"Buddy.Test46\Buddy.Test46.csproj",  
    r"Buddy.Test461\Buddy.Test461.csproj"
]

testProjectFiles = [
    r"Buddy.Test45.Test\Buddy.Test45.Test.csproj"
]

packageFiles = [
    r"nuspec\Buddy.Test.nuspec"
]
...
def pack():
    ...
    print("  Done packing to '{}'.".format(outputPath))
