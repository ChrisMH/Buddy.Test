...
$solution = "Buddy.Test.sln"         #relative to $srcRoot

[string[]] $projects =          #relative to $srcRoot
  "Buddy.Test45\Buddy.Test45.csproj", 
  "Buddy.Test451\Buddy.Test451.csproj",  
  "Buddy.Test452\Buddy.Test452.csproj",  
  "Buddy.Test46\Buddy.Test46.csproj",  
  "Buddy.Test461\Buddy.Test461.csproj"

[string[]] $testProjects =          #relative to $srcRoot
  "Buddy.Test45.Test\Buddy.Test45.Test.csproj"
